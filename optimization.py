...
# Update parameters when using momentum
...
# Update parameters when using Adam
...
######################################################
# MODEL WHICH CAN USE DIFFERENT OPTIMIZATION METHODS #
######################################################
...
def model(X, Y, layers_dims, optimizer, learning_rate=0.0007, mini_batch_size=64, beta=0.9,
    ...
    parameters = initialize_parameters(layers_dims)  # function found in nn_models.py
    ...
    for i in range(num_epochs):
        ...
        for minibatch in minibatches:
            ...
            # Forward propagation
            a3, caches = forward_propagation(minibatch_X, parameters)  # function found in nn_models.py

            # Compute cost and add to the cost total
            cost_total += compute_cost(a3, minibatch_Y)  # function found in nn_models.py

            # Backward propagation
            grads = backward_propagation(minibatch_X, minibatch_Y, caches)  # function found in nn_models.py
...
#####################################################################
# MODEL WHICH CAN USE LEARNING RATE DECAY (AND OTHER OPTIMIZATIONS) #
#####################################################################

def model_learn_decay(X, Y, layers_dims, optimizer, learning_rate=0.0007, mini_batch_size=64, beta=0.9,
...
# Update learning_rate (For learning rate decay)
